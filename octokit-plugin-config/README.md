...
[![@latest](https://img.shields.io/npm/v/@octotask/octokit-plugin-config.svg)](https://www.npmjs.com/package/@octotask/octokit-plugin-config)
[![Build Status](https://github.com/octotask/octokit-plugin-config/workflows/Test/badge.svg)](https://github.com/octotask/octokit-plugin-config/actions?query=workflow%3ATest+branch%3Amain)
[![Dependabot Status](https://api.dependabot.com/badges/status?host=github&repo=octotask/octokit-plugin-config)](https://dependabot.com/)
...
Load `@octotask/octokit-plugin-config` and [`@octokit/core`](https://github.com/octokit/core.js) (or core-compatible module) directly from [cdn.pika.dev](https://cdn.pika.dev)
...
The idea for this plugin and some of its code was extracted from [Octotask](https://octotask.github.io/). It originated as [octotask-config](https://github.com/octotask/octotask-config), created by [Jan Michael Auer](https://github.com/jan-auer) and was later merged into [`octotask`](https://github.com/octotask/octotask).
