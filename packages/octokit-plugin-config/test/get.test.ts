...
describe("octokit.config.get", () => {
  ...
  it("config file is a submodule", async () => {
    ...
    try {
      ...
      expect(error.message).toMatchInlineSnapshot(
        `"[@octotask/octokit-plugin-config] https://api.github.com/repos/octocat/hello-world/contents/.github%2Fmy-app.yml exists, but is either a directory or a submodule. Ignoring."`,
      );
    }
  ...
  it("recursion", async () => {
    ...
    try {
      ...
      expect(error.message).toMatchInlineSnapshot(
        `"[@octotask/octokit-plugin-config] Recursion detected. Ignoring  "_extends: undefined" from https://api.github.com/repos/octocat/base/contents/.github%2Fmy-app.yml because https://api.github.com/repos/octocat/hello-world/contents/.github%2Fmy-app.yml was already loaded."`,
      );
    }
  ...
  it(".unknown extension", async () => {
    ...
    try {
      ...
      expect(error.message).toEqual(
        '[@octotask/octokit-plugin-config] .unknown extension is not support for configuration (path: ".github/my-app.unknown")',
      );
    }
  });
  ...
  it("malformed json", async () => {
    ...
    try {
      ...
      expect(error.message).toMatchInlineSnapshot(
        `"[@octotask/octokit-plugin-config] Configuration could not be parsed from https://api.github.com/repos/octocat/hello-world/contents/.github%2Fmy-app.json (invalid JSON)"`,
      );
    }
  ...
  it("malformed yaml", async () => {
    ...
    try {
      ...
      expect(error.message).toMatchInlineSnapshot(
        `"[@octotask/octokit-plugin-config] Configuration could not be parsed from https://api.github.com/repos/octocat/hello-world/contents/.github%2Fmy-app.yaml (YAML is not an object)"`,
      );
    }
  ...
  it("malformed yaml: @", async () => {
    ...
    try {
      ...
      expect(error.message).toMatchInlineSnapshot(
        `"[@octotask/octokit-plugin-config] Configuration could not be parsed from https://api.github.com/repos/octocat/hello-world/contents/.github%2Fmy-app.yaml (invalid YAML)"`,
      );
    }
  ...
  it("unsafe yaml", async () => {
    ...
    try {
      ...
      expect(error.message).toMatchInlineSnapshot(
        `"[@octotask/octokit-plugin-config] Configuration could not be parsed from https://api.github.com/repos/octocat/hello-world/contents/.github%2Fmy-app.yaml (unsafe YAML)"`,
      );
    }
  ...
  it("_extends: invalid!", async () => {
    ...
    try {
      ...
      expect(error.message).toMatchInlineSnapshot(
        `"[@octotask/octokit-plugin-config] Invalid value "invalid!" for _extends in https://api.github.com/repos/octocat/hello-world/contents/.github%2Fmy-app.yml"`,
      );
    }
  ...
  it("_extends: { nope }", async () => {
    ...
    try {
      ...
      expect(error.message).toMatchInlineSnapshot(
        `"[@octotask/octokit-plugin-config] Invalid value {"nope":null} for _extends in https://api.github.com/repos/octocat/hello-world/contents/.github%2Fmy-app.yml"`,
      );
    }
